...
const FeedScreen: React.FC<Props> = ({}) => {
  const mockAuctionData = [
    {
      id: 1,
      auctionName: 'Yeezy Boost V2',
      authorName: 'Adam',
    },
    {
      id: 2,
      auctionName: 'Nike Airmax 95',
      authorName: 'Amam',
    },
    {
      id: 3,
      auctionName: 'Represent Hoodie',
      authorName: 'Aman',
    },
  ];
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text style={{marginVertical: 4}}> {item.authorName} </Text>
            </View>
          </View>
          <View
            style={{
            ...
            <IonIcon name={'heart-outline'} size={20} color={'white'} />
          </View>
        </View>
        <View
          style={{
  ...
  return (
    <ScrollView style={{}}>
      ...
      <View
        ...
        <Text style={{fontWeight: 'bold', fontSize: 40}}> Top Artist </Text>
        <Text style={{fontWeight: 'bold', fontSize: 20}}> View all </Text>
      </View>
    </ScrollView>
  );
};
